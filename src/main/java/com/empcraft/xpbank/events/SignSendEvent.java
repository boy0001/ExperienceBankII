 ...
 * <p>
 * Source:
 * https://raw.githubusercontent.com/blablubbabc/IndividualSigns/master/src/main/java/de/blablubbabc
 * /insigns/SignSendEvent.java
 * </p>
 */
public class SignSendEvent extends Event implements Cancellable {
  ...
  // non-api method: plugins shouldn't modify the string array directly because we want to keep
  // track if the lines were modified
